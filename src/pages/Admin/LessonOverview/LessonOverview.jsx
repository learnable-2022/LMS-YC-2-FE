...
function LessonOverview() {
  ...
  const courseDelete = (id, title) => {
    if (window.confirm(`Are you sure you want to delete this course ${title}`)) {
                  ...
                  <div className={styles.courseInfo}>
                    ...
                    <div className={styles.icons}>
                      ...
                      {course.admin._id == adminInfo._id ? (
                        <div className={styles.deleteCourse} onClick={() => courseDelete(course._id, course.title)}>
                          <AiFillDelete />
                        </div>) : ""}
                    </div>
